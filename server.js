...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(__dirname) {var path = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var httpProxy = __webpack_require__(9);
	var log = __webpack_require__(11);

	var cfg = __webpack_require__(2);
	var RequestHandler = __webpack_require__(1);
	...
	httpServer.listen(cfg.server.port, cfg.server.host, function(error) {
		...
		if (!cfg.isProduction) {
			log.warn(yb(' !  ') + g('Running in ') + gb('development') + g(' mode. ') + ( true ? yb('Hot-reload') + g(' is enabled.') : ''));
		} else {
	...
	if (true) {
	    module.hot.accept(1, function(){
	        ...
	        RequestHandler = __webpack_require__(1);
	    });
	}
